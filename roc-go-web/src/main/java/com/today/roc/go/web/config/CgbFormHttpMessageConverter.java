 ...
 * <pre class="code">
 * RestTemplate template = new RestTemplate();  // CgbFormHttpMessageConverter is configured by default
 ...
 * @see MultiValueMap
 */
public class CgbFormHttpMessageConverter implements HttpMessageConverter<MultiValueMap<String, ?>> {
    ...
    public CgbFormHttpMessageConverter() {
    ...
    private static class MultipartHttpOutputMessage implements HttpOutputMessage {
        ...
        /**
         * 将原编码 US-ASCII 修改为 UTF-8 ，解决文件上传乱码
         * @param name
         * @return
         */
